...
const Subheading = tw(SubheadingBase)`text-center md:text-left text-2xl font-extrabold`;
const Heading = tw(
  SectionHeading
)`mt-4 font-black text-left text-xl sm:text-3xl lg:text-4xl text-center md:text-left leading-tight`;
const Description = tw.p`mt-4 p-3 border-solid border-2 border-blue-500 rounded-md text-justify md:text-justify text-sm md:text-justify lg:text-justify font-medium leading-relaxed text-secondary-400`;
